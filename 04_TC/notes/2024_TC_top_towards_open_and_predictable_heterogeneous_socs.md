# paper_08 - TOP: Towards Open & Predictable Heterogeneous SoCs

## 一句话定位
这篇 TC 论文围绕 **TOP: Towards Open & Predictable Heterogeneous SoCs** 展开，核心是把一个明确的硬件/EDA/安全问题压缩成可实现、可度量、可对比的设计贡献。

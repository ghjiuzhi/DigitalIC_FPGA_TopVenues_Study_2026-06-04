# paper_07 - Fast Inner-Product Algorithms and Architectures for Deep Neural Network Accelerators

## 一句话定位
这篇 TC 论文围绕 **Fast Inner-Product Algorithms and Architectures for Deep Neural Network Accelerators** 展开，核心是把一个明确的硬件/EDA/安全问题压缩成可实现、可度量、可对比的设计贡献。

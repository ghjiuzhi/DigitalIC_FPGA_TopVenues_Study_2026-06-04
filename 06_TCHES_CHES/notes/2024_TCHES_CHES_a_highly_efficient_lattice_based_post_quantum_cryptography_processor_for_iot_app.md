# paper_02 - A Highly-efficient Lattice-based Post-Quantum Cryptography Processor for IoT Applications

## 一句话定位
这篇 TCHES/CHES 论文围绕 **A Highly-efficient Lattice-based Post-Quantum Cryptography Processor for IoT Applications** 展开，核心是把一个明确的硬件/EDA/安全问题压缩成可实现、可度量、可对比的设计贡献。

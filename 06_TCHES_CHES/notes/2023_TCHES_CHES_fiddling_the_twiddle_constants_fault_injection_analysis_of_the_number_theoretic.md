# paper_09 - Fiddling the Twiddle Constants - Fault Injection Analysis of the Number Theoretic Transform

## 一句话定位
这篇 TCHES/CHES 论文围绕 **Fiddling the Twiddle Constants - Fault Injection Analysis of the Number Theoretic Transform** 展开，核心是把一个明确的硬件/EDA/安全问题压缩成可实现、可度量、可对比的设计贡献。

# paper_09 - Hybrid Spatial and Temporal Computing Histogrammer in Soft Processor Core of a FPGA Device

## 一句话定位
这篇 TCAS-I 论文围绕 **Hybrid Spatial and Temporal Computing Histogrammer in Soft Processor Core of a FPGA Device** 展开，核心是把一个明确的硬件/EDA/安全问题压缩成可实现、可度量、可对比的设计贡献。

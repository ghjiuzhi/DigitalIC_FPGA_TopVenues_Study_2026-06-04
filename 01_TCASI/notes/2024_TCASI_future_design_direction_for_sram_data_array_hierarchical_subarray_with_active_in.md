# paper_04 - Future Design Direction for SRAM Data Array: Hierarchical Subarray With Active Interconnect

## 一句话定位
这篇 TCAS-I 论文围绕 **Future Design Direction for SRAM Data Array: Hierarchical Subarray With Active Interconnect** 展开，核心是把一个明确的硬件/EDA/安全问题压缩成可实现、可度量、可对比的设计贡献。

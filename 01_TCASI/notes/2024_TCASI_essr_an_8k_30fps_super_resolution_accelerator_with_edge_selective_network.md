# paper_08 - ESSR: An 8K@30FPS Super-Resolution Accelerator With Edge Selective Network

## 一句话定位
这篇 TCAS-I 论文围绕 **ESSR: An 8K@30FPS Super-Resolution Accelerator With Edge Selective Network** 展开，核心是把一个明确的硬件/EDA/安全问题压缩成可实现、可度量、可对比的设计贡献。

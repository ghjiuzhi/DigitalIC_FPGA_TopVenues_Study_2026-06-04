...
## 一句话定位
这篇 TCAS-I 论文围绕 **High-Speed Polynomials Multiplication HW Accelerator for CRYSTALS-Kyber** 展开，核心是把一个明确的硬件/EDA/安全问题压缩成可实现、可度量、可对比的设计贡献。

## 为什么属于数字 IC / FPGA 方向
它面向密码算法、PQC/FHE、PUF、侧信道或故障攻击防护，核心贡献落在安全硬件、加速器或硬件安全验证。 本篇在 metadata 中标注的相关性是：digital IC / architecture, cryptographic hardware。

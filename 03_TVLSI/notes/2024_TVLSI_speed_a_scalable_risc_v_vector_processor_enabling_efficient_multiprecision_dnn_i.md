# paper_07 - SPEED: A Scalable RISC-V Vector Processor Enabling Efficient Multiprecision DNN Inference

## 一句话定位
这篇 TVLSI 论文围绕 **SPEED: A Scalable RISC-V Vector Processor Enabling Efficient Multiprecision DNN Inference** 展开，核心是把一个明确的硬件/EDA/安全问题压缩成可实现、可度量、可对比的设计贡献。

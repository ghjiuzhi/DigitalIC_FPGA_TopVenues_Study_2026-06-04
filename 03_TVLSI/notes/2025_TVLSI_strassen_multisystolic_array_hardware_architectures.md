# paper_05 - Strassen Multisystolic Array Hardware Architectures

## 一句话定位
这篇 TVLSI 论文围绕 **Strassen Multisystolic Array Hardware Architectures** 展开，核心是把一个明确的硬件/EDA/安全问题压缩成可实现、可度量、可对比的设计贡献。

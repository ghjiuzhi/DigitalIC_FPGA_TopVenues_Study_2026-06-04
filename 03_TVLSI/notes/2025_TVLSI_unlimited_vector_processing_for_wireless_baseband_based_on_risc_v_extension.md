# paper_02 - Unlimited Vector Processing for Wireless Baseband Based on RISC-V Extension

## 一句话定位
这篇 TVLSI 论文围绕 **Unlimited Vector Processing for Wireless Baseband Based on RISC-V Extension** 展开，核心是把一个明确的硬件/EDA/安全问题压缩成可实现、可度量、可对比的设计贡献。

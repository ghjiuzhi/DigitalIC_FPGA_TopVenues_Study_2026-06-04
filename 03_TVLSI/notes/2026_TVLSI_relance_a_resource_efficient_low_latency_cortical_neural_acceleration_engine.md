# paper_01 - ReLANCE: A Resource-Efficient Low-Latency Cortical Neural Acceleration Engine

## 一句话定位
这篇 TVLSI 论文围绕 **ReLANCE: A Resource-Efficient Low-Latency Cortical Neural Acceleration Engine** 展开，核心是把一个明确的硬件/EDA/安全问题压缩成可实现、可度量、可对比的设计贡献。

## 为什么属于数字 IC / FPGA 方向
它围绕 SRAM/MRAM/RRAM/CAM/CIM/PIM、memristor 或近存计算，属于数字存储、存算融合或新型计算电路。 本篇在 metadata 中标注的相关性是：memory / CIM。

# paper_04 - Spatz: Clustering Compact RISC-V-Based Vector Units to Maximize Computing Efficiency

## 一句话定位
这篇 TCAD 论文围绕 **Spatz: Clustering Compact RISC-V-Based Vector Units to Maximize Computing Efficiency** 展开，核心是把一个明确的硬件/EDA/安全问题压缩成可实现、可度量、可对比的设计贡献。
